...
In my previous post I discussed the <a href="/blog/the-difference-between-a-tree-and-a-graph-data-structure/" target="_blank">difference between a graph data structure and a tree data structure</a>. Now that you understand the difference between the two data structures, I am going to show you how you can search through your data.
...
<img class="aligncenter size-full wp-image-770" src="/Tree001.jpg" alt="Tree001" width="400" height="239" />
...
<img class="aligncenter size-full wp-image-771" src="/Tree002.jpg" alt="breadth first search" width="400" height="219" />
...
<img class="aligncenter size-full wp-image-788" src="/Tree005.jpg" alt="Depth first search in javascript" width="400" height="355" />
<ol>
...
<img class="aligncenter size-full wp-image-789" src="/Tree007.jpg" alt="Depth first search in javascript" width="400" height="354" />
...
<img class="aligncenter size-full wp-image-790" src="/Tree009.jpg" alt="Depth first search in javascript" width="400" height="351" />
