...
<ul>
	<li>Write a reduce function</li>
	<li>Write two new methods that would extend the Array prototype</li>
	<li>Describe differences between a stack and an array</li>
...
<h2>Toy Problems</h2>
On Tuesday of Week 2 we had our introduction to <em>"Toy Problems."</em> Toy Problems are a daily event that will continue until graduation.
