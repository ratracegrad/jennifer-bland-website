...
A data structure is a particular way of organizing data in a computer so that it can be used efficiently.  Previously I talked about two very similar data structures - <a href="http://www.jenniferbland.com/the-difference-between-a-tree-and-a-graph-data-structure/" target="_blank">tree and graph</a>. Today I am going to talk about Linked Lists, Sets and Hash Tables.
...
<img class="aligncenter size-medium wp-image-841" src="http://www.jenniferbland.com/wp-content/uploads/linked-list-300x101.png" alt="linked list" width="300" height="101" />
...
<img class="aligncenter size-medium wp-image-842" src="http://www.jenniferbland.com/wp-content/uploads/Set-data-structure-300x123.png" alt="Set data structure" width="300" height="123" />
...
<img class="aligncenter size-medium wp-image-843" src="http://www.jenniferbland.com/wp-content/uploads/hash_table-300x208.png" alt="hash table" width="300" height="208" />
